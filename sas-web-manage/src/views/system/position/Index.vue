  ...
  <a-card :bordered="false">
    <a-row :gutter="8">
      <a-col :span='12'>
        ...
        <a-button class="mr5" @click="show.edit=true"><a-icon type="plus" /> 添加职位</a-button>
      ...
      <a-col class="tr" :span='12'>
        <a-input-group compact>
          <a-select defaultValue="name">
            <a-select-option value="name">职位名称</a-select-option>
            <a-select-option value="status">职位编码</a-select-option>
...
export default {
  ...
  data () {
    return {
      ...
      queryParam: {},
      res:{
        records:[{key:1,id:'1',name:'董事长',alias:'ds',status:true,sort:0}]
      },
      columns: [
        {title: '#',dataIndex: 'id'},
        {title: '职位名称',dataIndex: 'name'},
        {title: '职位编码',dataIndex: 'alias'},
